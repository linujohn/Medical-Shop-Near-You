    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnBanks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String medicine=txt.getText().toString();
                mMap.clear();
                String url = getUrl(latitude, longitude, search);
                Object[] DataTransfer = new Object[3];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
                DataTransfer[2]= medicine;
                Toast.makeText(MapsActivity.this, "You have entered :"+medicine,Toast.LENGTH_LONG).show();
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this, "These are your Nearby Medical Shops ! ",
